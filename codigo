...
Cuando se le da ls -la el usuario denomidado www-data tendra permisos sobre el directorio.

Luego se edito la configuracion por default de los sitios de apache con el siguiente commando

vim /etc/apache2/sites-enabled/000-default.conf

Al final de el archivo antes de que cerrar la etiqueta virtualhost asi
...
Despues se habilito el servicio de SHADOW de la siguiente manera
